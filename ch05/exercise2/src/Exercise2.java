 ...
 * 
 * * 編譯
 * * javac -sourcepath src -cp classes -d classes src/Exercise2.java
 * * javac -verbose -sourcepath src -cp classes -d classes src/Exercise2.java
 * * -verbose: 可看到編譯器進行編譯的過程
 * 
 * 
 * * 執行
 * * java -cp classes Exercise2
 */
